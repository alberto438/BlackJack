 ...
 * valorMano al string manocrupier */
    ...
    public static String[] crupier(String[] mazo, int totalMano){
        System.out.println("Ahora me toca a mi");
        String[] manocrupier = new String[2];
        manocrupier[0] = darCarta(mazo);
        manocrupier[1] = darCarta(mazo);
        System.out.println(Arrays.toString(manocrupier));
